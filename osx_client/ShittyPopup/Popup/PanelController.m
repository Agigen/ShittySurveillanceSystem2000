...
- (NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row {
    ...
    if( [tableColumn.identifier isEqualToString:@"ToiletColumn"])
    {
        Toilet *toilet = [self.toilets objectAtIndex:row];
        if (toilet.occupied) {
            cellView.imageView.image = [NSImage imageNamed:@"greenDot.gif"];
        } else {
            cellView.imageView.image = [NSImage imageNamed:@"redDot.gif"];
        }
        
        cellView.textField.stringValue = toilet.title;
        return cellView;
    }
...
//    NSLog(@"num rows is %@", [self.toilets count]);
